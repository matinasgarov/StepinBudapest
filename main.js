...
(function () {
  ...
  var translations = {
    en: {
      ...
      plan1f1: 'Met in person in the arrivals hall by a named member of our team, who stays with them through passport control and baggage',
      plan1f2: 'Driven to the address they have rented and walked to the door — we do not leave until they are inside',
      plan1f3: 'A first orientation on the spot: how the transport works, where the nearest shop and pharmacy are, and the number to call at any hour',
      plan1cta: 'Choose Basic',
      planBadge: 'Most Popular',
      plan2name: 'Standard', 
      plan2scope: 'From before the flight to their first week',
      plan2f1: 'Everything in Basic — the airport meeting, the transfer, and the first orientation',
      plan2f2: 'A housing search run for you: dormitory or private flat matched to your budget, every option visited by our own team in person before you are shown it',
      plan2f3: 'The paperwork handled end to end — residence permit prepared and filed, university registration completed before term starts, and legal guardianship arranged',
      ...
      plan3name: 'Premium', 
      plan3scope: 'From before the flight to fully settled',
      plan3f1: 'Everything in Standard — arrival, housing search, residence permit, university registration and guardianship',
      plan3f2: 'A Hungarian bank account opened in their name, a local SIM card, and a student transport pass — the three things they cannot start ordinary life without',
    ...
    az: {
      ...
      plan1name: 'Basic',
      plan1scope: 'Enişdən qapısına qədər',
      plan1f1: 'Komandamızın adı bəlli olan üzvü onu gəliş zalında şəxsən qarşılayır və pasport nəzarətindən baqaj alınmasına qədər yanında olur',
      plan1f2: 'Kirayələdiyi ünvana çatdırırıq və qapıya qədər ötürürük — içəri girənə qədər getmirik',
      plan1f3: 'Yerindəcə ilkin orientasiya: nəqliyyatın necə işlədiyi, ən yaxın mağaza və aptekin harada olduğu və istənilən saatda zəng edə biləcəyi nömrə',
      plan1cta: 'Basic seçin',
      planBadge: 'Ən Populyar',
      plan2name: 'Standard', 
      plan2scope: 'Uçuşdan əvvəldən ilk həftəsinə qədər',
      plan2f1: 'Basic-dəki hər şey — hava limanı qarşılaması, çatdırılma və ilkin orientasiya',
      plan2f2: 'Sizin üçün aparılan yaşayış axtarışı: büdcənizə uyğun yataqxana və ya ayrıca mənzil, hər variantı sizə göstərməzdən əvvəl öz komandamız şəxsən yoxlayır',
      plan2f3: 'Sənədlər başdan sona həll olunur — oturum icazəsi hazırlanıb təqdim edilir, universitet qeydiyyatı semestr başlamazdan əvvəl tamamlanır və hüquqi qəyyumluq təşkil olunur',
      plan2cta: 'Standard seçin',
      plan4name: 'Öz paketini hazırla',
      plan4scope: 'Yalnız lazım olanı seçin, qiymətini biz deyək', plan4price: 'Siz seçin', plan4legend: 'Nəyə ehtiyacınız var?',
      ...
      plan3name: 'Premium', 
      plan3scope: 'Uçuşdan əvvəldən tam yerləşənə qədər',
      plan3f1: 'Standard-dakı hər şey — qarşılama, yaşayış axtarışı, oturum icazəsi, universitet qeydiyyatı və qəyyumluq',
      plan3f2: 'Onun adına açılmış Macarıstan bank hesabı, yerli SIM kart və tələbə nəqliyyat kartı — gündəlik həyata başlamaq üçün üç vacib şey',
    ...
    ru: {
      ...
      plan1f1: 'Наш сотрудник встречает его лично в зале прилёта и остаётся рядом на паспортном контроле и получении багажа',
      plan1f2: 'Отвозим по адресу, который он снял, и провожаем до двери — не уезжаем, пока он не зайдёт внутрь',
      plan1f3: 'Первая ориентация на месте: как работает транспорт, где ближайший магазин и аптека и по какому номеру звонить в любое время',
      plan1cta: 'Выбрать базовый',
      planBadge: 'Популярный выбор',
      plan2name: 'Стандарт', 
      plan2scope: 'От подготовки к вылету до первой недели',
      plan2f1: 'Всё из базового пакета — встреча в аэропорту, трансфер и первая ориентация',
      plan2f2: 'Поиск жилья под ключ: общежитие или отдельная квартира под ваш бюджет, и каждый вариант наша команда осматривает лично, прежде чем показать вам',
      plan2f3: 'Документы под ключ — вид на жительство подготовлен и подан, регистрация в университете завершена до начала семестра, юридическое опекунство оформлено',
      plan2cta: 'Выбрать стандарт',
      ...
      plan3name: 'Премиум', 
      plan3scope: 'От подготовки к вылету до полного обустройства',
      plan3f1: 'Всё из стандартного пакета — встреча, поиск жилья, вид на жительство, регистрация в университете и опекунство',
      plan3f2: 'Венгерский банковский счёт на его имя, местная SIM-карта и студенческий проездной — три вещи, без которых обычная жизнь не начнётся',
